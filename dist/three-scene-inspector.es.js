...
class O {
  constructor(e, t) {
    this.onSelectionChange = t, this.buttons = /* @__PURE__ */ new Map(), this.selectedObject = null, this.currentScene = null, this.folderObjects = /* @__PURE__ */ new Set(), this.pane = new u({ container: e, title: "Scene Tree" }), this.searchElement = this.createSearchElement();
  }
  get searchQuery() {
...
class F {
  constructor(e, t) {
    this.folders = /* @__PURE__ */ new Map(), this.selectedObject = null, this.propertiesTriggeringRefresh = [], this.propertiesTriggeringRebuild = ["castShadow"], this.isRefreshing = !1, this.pane = new u({ container: e, title: "Properties" }), this.pane.registerPlugin(B), this.helperManager = new P(t), this.propertyBinder = new T((n) => {
