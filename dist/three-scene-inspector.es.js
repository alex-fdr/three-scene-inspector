...
import { RepeatWrapping as g, ClampToEdgeWrapping as m, MirroredRepeatWrapping as f, NoColorSpace as v, SRGBColorSpace as y, LinearSRGBColorSpace as x, FrontSide as k, BackSide as w, DoubleSide as S, BoxHelper as C, CameraHelper as h, DirectionalLightHelper as P } from "three";
...
class O {
  constructor(e, t) {
    this.onSelectionChange = t, this.buttons = /* @__PURE__ */ new Map(), this.selectedObject = null, this.currentScene = null, this.folderObjects = /* @__PURE__ */ new Set(), this.excludeLabels = ["__inspector_bounding_box__"], this.pane = new b({ container: e, title: "Scene Tree" }), this.searchElement = this.createSearchElement();
  }
  get searchQuery() {
  ...
  helperDescriptors(e) {
    switch (e.type) {
      case "DirectionalLight": {
        const t = e, r = [
          { label: "Light Helper", createFn: () => new P(t, 1) }
        ];
...
class F {
  constructor(e, t) {
    this.folders = /* @__PURE__ */ new Map(), this.selectedObject = null, this.propertiesTriggeringRefresh = [], this.propertiesTriggeringRebuild = ["castShadow"], this.isRefreshing = !1, this.extraProperties = {}, this.overriddenProperties = {}, this.pane = new b({ container: e, title: "Properties" }), this.pane.registerPlugin(_), this.helperManager = new E(t), this.propertyBinder = new T((r) => {
...
function L() {
  ...
  p.textContent = B, document.head.appendChild(p), u = !0;
}
class M {
  constructor(e) {
    this.scene = e, this.panelsContainer = null, L();
    const { hierarchyContainer: t, propertyContainer: r } = this.createPanelContainers();
    this.hierarchyPanel = new O(t, this.onObjectSelected.bind(this)), this.propertyPanel = new F(r, this.scene), this.refresh();
  }
